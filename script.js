...
var teenused = $("#teenused-list-text li");
function changeText(index){
    ...
    highlightTeenusedElement(index);
}
function highlightTeenusedElement(index){
    teenused.removeClass();
    teenused.eq(index).addClass("teenused-list-active-element");
}
//set default highlighted element and default text
changeText(0);
highlightTeenusedElement(0);
